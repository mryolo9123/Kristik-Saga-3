...
label start:
    ...
    label sc1:
        ...
        play backgroundmusic "audio/Three_Wise_People.mp3"
        ...
        label u1:
            ...
            mom "Whatever...."
            krismind "always thinking im nutting..."
            ...
            kris "MOM! WTF? WHY DID YOU HAVE TO BUST IN MY ROOM??? AND I DIDNT EVEN DO THAT YET! I BARELY TALKED TO HER!!"
        ...
        label bothhit:
                window show
                kris "(I'll try hitting on both of them...)"
                kris "Hey guys. Could you come here?"
                show ssuo0113: 
                    linear 0.0 xalign 0.8
                $ renpy.transition(Dissolve(0.2))
                show smay0101: 
                ...
                $ renpy.pause(0.3, hard=True) 
                girl1 "What is it?"
                girl2 "Yeah yeah what's going on?"
                kris "(what should i say?)"
                window hide
                menu:
                    "Hug both of them":
                ...
                label hugboth:
                    ...
                    $ renpy.transition(Dissolve(0.2))
                    $ renpy.pause(0.3, hard=True) 
                    #########<<<<<<<<<ADD CLOTHES HUG RUSTING SOUND
                    kris "*hug*{p=1.0}{nw}"
                    show smay0117
                    girl2 "W-what was that for???"
                    hide smay0117
                    kris "Hey Asami..."
                    show ssuo0105
                    $ renpy.transition(Dissolve(0.2))
                    ...
                    $ renpy.transition(Dissolve(0.2))
                    $ renpy.pause(0.3, hard=True) 
                    girl1 "So what was this even for??1"
                    girl2 "Y-Yeah... That was sort of uncalled for..."
                    kris "Oh nothing... Just wanted to hug you both that's all."
                    hide ssuo0104
                    $ renpy.transition(Dissolve(0.2))
                    hide smay0117
                    $ renpy.transition(Dissolve(0.2))
                ...
                label kissboth:
                    ...
                    $ renpy.pause(2.0, hard=True) 
                    kris "Hey Asami..."
                    kris "You wouldn't want to be left out would you?'"
                    show ssuo0105
                    $ renpy.transition(Dissolve(0.2))
                    $ renpy.pause(0.3, hard=True) 
                    girl1 "Yeah... I know..."
                    ...
                    girl1 "So what was this even for??1"
                    girl2 "Y-Yeah... That was sort of uncalled for..."
                    kris "Oh nothing... Just wanted to kiss you both that's all."
                    hide ssuo0104
                    $ renpy.transition(Dissolve(0.2))
                    hide smay0117
                    $ renpy.transition(Dissolve(0.2))
        ...
        label planroom: 
            ...
            label takeout:
                    ...
                    label homefastfoodcometogether:
                        ...
                        if else foodtype == 1:
                            kris "I just went to McDonalds and got a Big Mac. I also got a burrito from 7-eleven but those two told me to get something more."
                            hide smay0101
                            hide ssuo0101
                            hide srik0101
                            hide syuz0101
